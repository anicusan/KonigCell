...
sys.path.insert(0, os.path.abspath('../../konigcell'))
...
project = 'KonigCell'
copyright = '2021, Andrei Leonard Nicusan'

# The full version, including alpha/beta/rc tags
# Load the package's __version__.py module as a dictionary.
about = {}
with open('../../konigcell/__version__.py') as f:
    exec(f.read(), about)
...
html_theme_options = {
    ...
    "github_url": "https://github.com/anicusan/KonigCell",
...
latex_documents = [
    ('index', 'KonigCell.tex', u'KonigCell Documentation',
     u'KonigCell maintainers', 'manual'),
]
