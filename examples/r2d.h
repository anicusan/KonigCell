 ...
 *
 *      In May 2021 the correct single or double precision power functions were added. The code was
 *      optimised for `polyorder = 0`; variable-length arrays were removed to allow compilation with 
 *      MSVC.
 *
