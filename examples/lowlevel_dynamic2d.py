...
radii = generate(num_particles, *radii_range)
...
for i in range(num_particles - 1):
    ...
    area_analytical += (radii[i] + radii[i + 1]) * np.linalg.norm(distance)

area_analytical += 0.5 * np.pi * radii[num_particles - 1] ** 2
